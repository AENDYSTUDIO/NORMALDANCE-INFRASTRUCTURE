  ...
  development: {
    ...
    secrets: [
      ...
      },
      {
        ...
        description:
          "Секрет для NextAuth.js (должен быть случайным и уникальным)",
        required: true,
        sensitive: true,
        platforms: ["render", "vercel", "railway"],
      ...
      },
      {
        ...
        examples: [
          "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZS1kZW1vIiwicm9sZSI6ImFub24iLCJleHAiOjE5OTQ1ODM5NTl9.Tu8E445sru__7-445sru__7-445sru__7-45sru__7-445sru__7-445sru__7-445sru__7-445sru__7-4",
        ],
      },
      {
        name: "NEXTAUTH_URL",
  ...
  staging: {
    ...
    secrets: [
      ...
      },
      {
        ...
        examples: [
          "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZS1kZW1vIiwicm9sZSI6ImFub24iLCJleHAiOjE5OTQ1ODM5NTl9.Tu8E445sru__7-445sru__7-445sru__7-45sru__7-445sru__7-445sru__7-445sru__7-445sru__7-445sru__7-4",
        ],
      },
      {
        name: "NEXTAUTH_URL",
  ...
  production: {
    ...
    secrets: [
      ...
      },
      {
        ...
        examples: [
          "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZS1kZW1vIiwicm9sZSI6ImFub24iLCJleHAiOjE5OTQ1ODM5NTl9.Tu8E445sru__7-445sru__7-445sru__7-45sru__7-445sru__7-445sru__7-445sru__7-445sru__7-445sru__7-445sru__7-4",
        ],
      },
      {
        name: "NEXTAUTH_URL",
...
const templateUtils = {
    ...
    if (template.secrets) {
      template.secrets.forEach((secret, index) => {
        ...
        if (secret.required && !secret.defaultValue) {
          errors.push(
            `Required secret '${secret.name}' must have a default value`
          );
        }
        ...
        if (secret.validation && secret.validation.pattern) {
          try {
            ...
            errors.push(
              `Invalid regex pattern for secret '${secret.name}': ${e.message}`
            );
          }
        }
      });
  ...
  generateReport() {
    ...
    Object.entries(secretsTemplates).forEach(([env, template]) => {
      ...
      report.summary.requiredSecrets += template.secrets.filter(
        (s) => s.required
      ).length;
      report.summary.optionalSecrets += template.secrets.filter(
        (s) => !s.required
      ).length;
    });
