    ...
    describe("getTokenBalance", () => {
      ...
      it("should return token balance when account exists", async () => {
        ...
        (
          ...
          amount: new BN(1000000), // 1 token with 9 decimals
        });
  ...
  describe("Utility Functions", () => {
    ...
    describe("formatTokens", () => {
      it("should format token amount with Russian locale", () => {
        expect(formatTokens(1000)).toBe("1 000.0");
        expect(formatTokens(1234567.89, 6)).toBe("1 234 567.89000");
      });
